...
class MyProblem2(ea.Problem):
    ...
    def aimFunc(self, pop):
        ...
        f1 = 8.60 * x1 + 88 * (x1 - 1.83) - 2549.29
        f2 = 11.78 * x2 + 88 * (x2 - 5.12) - 710.16
        f3 = 16.29 * x3 + 88 * (x3 - 0.325) - 201.39
        f4 = 13.4 * x4 + 88 * (x4 - 1.62) - 516.83
